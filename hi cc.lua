...
QuestNeta = function()
	...
	local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/nyanndzvkl/test/refs/heads/main/hi.lua"))():MakeWindow({
    Title = "nyann os fram",
    SubTitle = " | Blox Fruit",
...
Status:AddDiscordInvite({
    ...
    Invite = "https://nyannosfram/discord"
})
